...
var did_provider_web_1 = require("@veramo/did-provider-web"); // Import the DID provider web module
var did_resolver_1 = require("did-resolver");
var web_did_resolver_1 = require("web-did-resolver"); // Import the resolver for web DIDs
function main() {
                    ...
                    agent = (0, core_1.createAgent)({
                        plugins: [
                            ...
                            new did_manager_1.DIDManager({
                                ...
                                resolver: new did_resolver_1.Resolver((0, web_did_resolver_1.getResolver)()),
                            }),
                            // Use the DID Web provider plugin
                            new did_provider_web_1.DIDWeb(),
                        ],
                    });
