...
var did_comm_1 = require("@veramo/did-comm");
var did_manager_1 = require("@veramo/did-manager");
var message_handler_1 = require("@veramo/message-handler");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    agent.addMessageHandler(new did_comm_1.DIDCommMessageHandler());
                    // Listen for incoming messages
                    return [4 /*yield*/, agent.listen()];
                case 1:
                    // Listen for incoming messages
                    _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error handling connection messages:', error_1);
                    return [3 /*break*/, 3];
