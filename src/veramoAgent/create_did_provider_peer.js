...
var did_peer_1 = require("@veramo/did-peer");
// Create Veramo agent with necessary plugins
var agent = (0, core_1.createAgent)({
    plugins: [
        new did_manager_1.DIDManager(),
        new did_peer_1.DIDPeer(),
    ],
});
// Create a new DID:Peer
function createDIDPeer() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, didPeer];
                case 2:
                    error_1 = _a.sent();
                    console.error('Error creating DID:Peer:', error_1);
                    return [3 /*break*/, 3];
